...
st.set_page_config(
    page_title="Chainlink Price Prediction",
    page_icon="https://cryptologos.cc/logos/chainlink-link-logo.png?v=032"
)
...
fig = px.line(new_pred_plot, x=new_pred_plot.index, y=[new_pred_plot['last_original_days_value'],
              ...
              labels={'value': 'Chainlink price', 'index': 'Timestamp'})
